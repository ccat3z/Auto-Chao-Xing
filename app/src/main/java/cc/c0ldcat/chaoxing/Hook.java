...
import cc.c0ldcat.chaoxing.modules.AutoNext;
...
public class Hook implements IXposedHookLoadPackage {
    private static Class<?>[] moduleClasses = new Class<?>[] {VideoTest.class, WebViewDebug.class, AutoPlay.class, AutoNext.class};
